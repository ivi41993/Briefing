...
# --- CONFIGURACIÓN FIIX WFS2A ---
FIIX_SITE_ID = 29449435
TAG_NAVE = "WFS2A"  # <--- FILTRO CLAVE: Buscará activos con "WFS2A" en el nombre
ID_PREVENTIVO = 531546
ID_URGENTE = 278571

# Memoria vacía al inicio (Se llenará en la primera carga)
fiix_memory_cache = {}
...
# -----------------------------------
# ==========================================
# 1. CONFIGURACIÓN ESPECÍFICA DE UBICACIÓN
# ==========================================
# CAMBIA ESTO SEGÚN LA SEDE:
SCALA_API = "MAD"   # Opciones: "MAD", "BCN", "VLC", "ALM"
NAVE_TARGET = "N2"  # Opciones: "N1", "N2", "N3", "N4" o "TODO" (para BCN/VLC/ALM)
