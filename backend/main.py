...
async def fiix_auto_worker():
    ...
    print("👷 Worker Fiix: Iniciado.")
    while True:
        try:
            # Lanza la métrica de WFS4
...
async def get_fiix_current():
    ...
    # Si por alguna razón el worker no ha cargado, forzamos una carga rápida
